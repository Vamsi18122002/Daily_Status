console.log("JavaScript Topics")
console.log("Introduction to JavaScript")
console.log("JavaScript : Static Webpage converts into Dynamic Webpage and  add  functionality to the user")
...
let r12 = false
if(t>r12){
    console.log("t is greater than r12")
}else{
    console.log("t is less than the r12")
}
...
switch (name) {
    case "vasikar":
        console.log("Vasikar – a person who attracts others.")  
        break; 
    case "sashi":
        console.log("someone who is calm, gentle, and brings light to others.")
        break;
    case "rashi":
        console.log("Rashi means “zodiac sign” in Indian astrology.")
        break;
        default:
        console.log("Not there in this switch")
}
}
sw("sashi")
