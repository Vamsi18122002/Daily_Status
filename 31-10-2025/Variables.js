console.log("you have to run the javaScript code. we have 2 phases") 
console.log("1.memory creation")
console.log("2.code execution")

console.log("Memory Creation Phase")
console.log("In memory, var is initialized with undefined")
console.log("In memory, let is initialized with value unavaliable")
console.log("In memory, const is initialized with value unavaliable")



console.log("Code Execution Phase Starts");
var a = 10;
let b = 20;
